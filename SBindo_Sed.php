...
<div data-role="page" style="background-image:url(Walpaper/wlpr2.jpg); font-family: 'Palatino Linotype', 'Book Antiqua', Palatino, serif; text-align: left;">
    ...
    <a data-role="button" href="Soal_Bindonesia.php" data-transition="pop" data-icon="arrow-l" data-corners="false">Back</a><br>
	<h1 align="justify">Lavel Sedang</h1>
</div>  
<form id="form1" name="form1" method="post" action="jawabBhsSed.php">

<b>1. Gagasan utama yang terdapat dalam sebuah paragraf disebut...</b>
<table width="300" border="0">
  <tr>
    <th width="37" scope="col" align="left"><input name="soal1" type="radio" value="A"/></th>
    <th width="1" scope="col"></th>
    <th width="233" scope="col" align="left">Gagasan penjelas</th>
  </tr>
  <tr>
    <th scope="col" align="left"><input name="soal1" type="radio" value="B"></th>
    <th scope="col"></th>
    <th scope="col" align="left">Pikiran penjelas</th>
  </tr>
  <tr>
   <th scope="col" align="left"><input name="soal1" type="radio" value="C"></th>
    <th scope="col"></th>
    <th scope="col" align="left">Pokok pikiran</th>
  </tr>
</table>
<!-------------------------------------------------->
<b>2. Loket adalah tempat....</b>
<table width="300" border="0">
  <tr>
    <th width="37" scope="col" align="left"><input name="soal2" type="radio" value="A"></th>
    <th width="1" scope="col"></th>
    <th width="233" scope="col" align="left" >Mementaskan drama</th>
  </tr>
  <tr>
    <th scope="col" align="left"><input name="soal2" type="radio" value="B"></th>
    <th scope="col"></th>
    <th scope="col" align="left">Berlatihan olahraga</th>
  </tr>
  <tr>
   <th scope="col" align="left"><input name="soal2" type="radio" value="C"></th>
    <th scope="col"></th>
    <th scope="col" align="left">Menjual tiket</th>
  </tr>
</table>
<!-------------------------------------------->
<b>3. Ia kaya.....kikir<br>
Kata penghubung yang tepat untuk melengkapi kalimat tersebut adalah....</b>
<table width="300" border="0">
  <tr>
    <th width="37" scope="col" align="left"><input name="soal3" type="radio" value="A"></th>
    <th width="1" scope="col"></th>
    <th width="233" scope="col" align="left" >Dan</th>
  </tr>
  <tr>
    <th scope="col" align="left"><input name="soal3" type="radio" value="B"></th>
    <th scope="col"></th>
    <th scope="col" align="left">Tetapi</th>
  </tr>
  <tr>
   <th scope="col" align="left"><input name="soal3" type="radio" value="C"></th>
    <th scope="col"></th>
    <th scope="col" align="left">Bahwa</th>
  </tr>
</table>
<!----------------------------------------------->
<b>4. Ibu pulang dari Surabaya<br>
Pertanyaan yang tepat untuk jawaban diatas adalah...</b>
<table width="300" border="0">
  <tr>
    <th width="37" scope="col" align="left"><input name="soal4" type="radio" value="A"></th>
    <th width="1" scope="col"></th>
    <th width="233" scope="col" align="left" >Ibu pulang dari mana?</th>
  </tr>
  <tr>
    <th scope="col" align="left"><input name="soal4" type="radio" value="B"></th>
    <th scope="col"></th>
    <th scope="col" align="left">Kapan ibu pulang?</th>
  </tr>
  <tr>
   <th scope="col" align="left"><input name="soal4" type="radio" value="C"></th>
    <th scope="col"></th>
    <th scope="col" align="left">Di mana ibu pulang?</th>
  </tr>
</table>
<!----------------------------------------------->
<b>5. Kata "mengakhiri" bila diuraikan suku katanya menjadi....</b>
<table width="300" border="0">
  <tr>
    <th width="37" scope="col" align="left"><input name="soal5" type="radio" value="A"></th>
    <th width="1" scope="col"></th>
    <th width="233" scope="col" align="left" >Menga-khr-i</th>
  </tr>
  <tr>
    <th scope="col" align="left"><input name="soal5" type="radio" value="B"></th>
    <th scope="col"></th>
    <th scope="col" align="left">Meng-a-khir-i</th>
  </tr>
  <tr>
   <th scope="col" align="left"><input name="soal5" type="radio" value="C"></th>
    <th scope="col"></th>
    <th scope="col" align="left">Me-nga-khir-i</th>
  </tr>
</table>
<!----------------------------------------------->
<b>6. Dua baris terakhir dalam pantun disebut...</b>
<table width="300" border="0">
  <tr>
    <th width="37" scope="col" align="left"><input name="soal6" type="radio" value="A"/></th>
    <th width="1" scope="col"></th>
    <th width="233" scope="col" align="left" >Isi</th>
  </tr>
  <tr>
    <th scope="col" align="left"><input name="soal6" type="radio" value="B"/></th>
    <th scope="col"></th>
    <th scope="col" align="left">Sampiran</th>
  </tr>
  <tr>
   <th scope="col" align="left"><input name="soal6" type="radio" value="C"/></th>
    <th scope="col"></th>
    <th scope="col" align="left">Salam</th>
  </tr>
</table>
<!----------------------------------------------->
<b>7. Perhatikan percakapan ini!<br>
<img src="Walpaper/Pargraf.jpg" width="303" height="224"><br>
Percakapan diatas berupa...
<table width="300" border="0">
  <tr>
    <th width="37" scope="col" align="left"><input name="soal7" type="radio" value="A"/></th>
    <th width="1" scope="col"></th>
    <th width="233" scope="col" align="left">Percakapan di sekolah</th>
  </tr>
  <tr>
    <th scope="col" align="left"><input name="soal7" type="radio" value="B"/></th>
    <th scope="col"></th>
    <th scope="col" align="left">Percakapan melalui telpon</th>
  </tr>
  <tr>
   <th scope="col" align="left"><input name="soal7" type="radio" value="C"/></th>
    <th scope="col"></th>
    <th scope="col" align="left">Percakapan di rumah</th>
  </tr>
</table>
<!----------------------------------------------->
<b>8. Lihat percakapan No 7<br>
Siapa yang mengangkat telpon bunga...</b>
<table width="300" border="0">
  <tr>
    <th width="37" scope="col" align="left"><input name="soal8" type="radio" value="A"/></th>
    <th width="1" scope="col"></th>
    <th width="233" scope="col" align="left" >Ani</th>
  </tr>
  <tr>
    <th scope="col" align="left"><input name="soal8" type="radio" value="B"/></th>
    <th scope="col"></th>
    <th scope="col" align="left">Bungga</th>
  </tr>
  <tr>
   <th scope="col" align="left"><input name="soal8" type="radio" value="C"/></th>
    <th scope="col"></th>
    <th scope="col" align="left">Ratna</th>
  </tr>
</table>
<!----------------------------------------------->
<b>9. Anak yang rajin pasti...
</b>
<table width="300" border="0">
  <tr>
    <th width="37" scope="col" align="left"><input name="soal9" type="radio" value="A"/></th>
    <th width="1" scope="col"></th>
    <th width="233" scope="col" align="left" >Kaya</th>
  </tr>
  <tr>
    <th scope="col" align="left"><input name="soal9" type="radio" value="B"/></th>
    <th scope="col"></th>
    <th scope="col" align="left">Bodoh</th>
  </tr>
  <tr>
   <th scope="col" align="left"><input name="soal9" type="radio" value="C"/></th>
    <th scope="col"></th>
    <th scope="col" align="left">Pintar</th>
  </tr>
</table>
<!---------------------------------------------->
<b>10. Penulisan kata depan yang tepat terdapat pada kalimat....</b>
<table width="300" border="0">
  <tr>
    <th width="37" scope="col" align="left"><input name="soal10" type="radio" value="A"/></th>
    <th width="1" scope="col"></th>
    <th width="233" scope="col" align="left" >Rani dan Wina pergi kesolo</th>
  </tr>
  <tr>
    <th scope="col" align="left"><input name="soal10" type="radio" value="B"/></th>
    <th scope="col"></th>
    <th scope="col" align="left">Siswa kelas VI berjalan-jalan ke pantai</th>
  </tr>
  <tr>
   <th scope="col" align="left"><input name="soal10" type="radio" value="C"/></th>
    <th scope="col"></th>
    <th scope="col" align="left">Nenek menjenguk adik dikamar</th>
  </tr>
</table>
<!------------------------------------------------>
<table width="300" border="0">
